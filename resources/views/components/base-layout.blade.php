...
<head>
    ...
    <!-- TesoTunes Player Core - MUST load before Alpine.js -->
    <script src="{{ asset('js/tesotunes-player.js') }}"></script>
...
-->
    ...
    <!-- SPA-Lite Navigation (preserves audio across page loads) -->
    <script src="{{ asset('js/spa-lite.js') }}"></script>

    <!-- Alpine.js is already initialized in app.js -->
