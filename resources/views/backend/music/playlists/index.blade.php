    ...
    <div class="card mb-6">
        ...
        <form method="GET" class="p-4">
            ...
            <div class="mt-4 flex justify-end space-x-2">
                <a href="{{ route('backend.music.playlists.index') }}" class="btn border border-slate-300 font-medium text-slate-700 hover:bg-slate-150 dark:border-navy-450 dark:text-navy-100 dark:hover:bg-navy-500">
                    Clear
                </a>
                ...
                <div class="p-4">
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <a href="{{ route('backend.music.playlists.show', $playlist) }}" class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                            ...
                            <a href="{{ route('backend.music.playlists.edit', $playlist) }}" class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="flex items-center space-x-1">
                            @if($playlist->type === 'user')
                                <form method="POST" action="{{ route('backend.music.playlists.toggle-featured', $playlist) }}" class="inline">
                                    @csrf
                            ...
                            <form method="POST" action="{{ route('backend.music.playlists.destroy', $playlist) }}" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25"
