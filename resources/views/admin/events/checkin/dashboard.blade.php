...
@section('title', 'Check-in Dashboard - ' . $event->title)
...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Check-in Dashboard</h1>
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('admin.events.checkin.export', $event) }}"
        ...
        <div class="bg-white rounded-lg p-6 shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($stats['total_attendees']) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg p-6 shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($stats['checked_in']) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg p-6 shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($stats['pending_checkin']) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg p-6 shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $stats['checkin_rate'] }}%</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="px-6 py-4 flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-500">{{ $attendee->ticket_code }} • {{ $attendee->ticket_type }}</p>
                        </div>
                    </div>
                    <div class="text-right">
                        <p class="text-sm text-gray-900">{{ $attendee->checked_in_at->format('g:i A') }}</p>
                        <p class="text-sm text-gray-500">{{ $attendee->checked_in_at->format('M j') }}</p>
                    </div>
                </div>
            @empty
