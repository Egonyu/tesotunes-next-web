<x-base-layout title="Register">
    @php
        ...
        $platformName = \App\Models\Setting::get('platform_name', config('app.name'));
    @endphp
    <div class="fixed top-0 hidden p-6 lg:block lg:px-12">
        <a href="#" class="flex items-center space-x-2">
            <img class="size-12" src="{{ asset($siteLogo) }}" alt="logo" />
    ...
    <div class="hidden w-full place-items-center lg:grid">
        <div class="w-full max-w-lg p-6">
            <img class="w-full" x-show="!$store.global.isDarkModeEnabled" x-cloak
    ...
    <main class="flex w-full flex-col items-center bg-white dark:bg-navy-700 lg:max-w-md">
        <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
            <div class="text-center">
                <img class="mx-auto size-16 lg:hidden" src="{{ asset($siteLogo) }}" alt="logo" />
                <div class="mt-4">
            ...
            @if ($errors->any())
                <div class="alert bg-error/10 text-error mb-4 rounded-lg p-4">
