...
<div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Update slide settings and content</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg">
        <form method="POST" action="{{ route('admin.slideshow.update', $slide) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="object_type" id="object_type" required
                                ...
                                <option value="song" {{ old('object_type', $slide->object_type) == 'song' ? 'selected' : '' }}>Song</option>
                                <option value="album" {{ old('object_type', $slide->object_type) == 'album' ? 'selected' : '' }}>Album</option>
                                <option value="artist" {{ old('object_type', $slide->object_type) == 'artist' ? 'selected' : '' }}>Artist</option>
                                <option value="playlist" {{ old('object_type', $slide->object_type) == 'playlist' ? 'selected' : '' }}>Playlist</option>
                                <option value="station" {{ old('object_type', $slide->object_type) == 'station' ? 'selected' : '' }}>Radio Station</option>
                            </select>
                            @error('object_type')
                        ...
                        <div>
                            ...
                            <input type="number" name="object_id" id="object_id" required value="{{ old('object_id', $slide->object_id) }}"
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="url" name="title_link" id="title_link" value="{{ old('title_link', $slide->title_link) }}"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                               placeholder="https://">
                        @error('title_link')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                              placeholder="Brief description...">{{ old('description', $slide->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="priority" id="priority" value="{{ old('priority', $slide->priority) }}"
                           class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                           placeholder="0">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="allow_home" name="allow_home" type="checkbox" value="1" {{ old('allow_home', $slide->allow_home) ? 'checked' : '' }}
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="allow_discover" name="allow_discover" type="checkbox" value="1" {{ old('allow_discover', $slide->allow_discover) ? 'checked' : '' }}
                                       class="focus:ring-primary-500 h-4 w-4 text-primary-600 border-gray-300 rounded">
                            </div>
                            <div class="ml-3 text-sm">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="allow_radio" name="allow_radio" type="checkbox" value="1" {{ old('allow_radio', $slide->allow_radio) ? 'checked' : '' }}
                                       class="focus:ring-primary-500 h-4 w-4 text-primary-600 border-gray-300 rounded">
                            </div>
                            <div class="ml-3 text-sm">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="allow_community" name="allow_community" type="checkbox" value="1" {{ old('allow_community', $slide->allow_community) ? 'checked' : '' }}
                                       class="focus:ring-primary-500 h-4 w-4 text-primary-600 border-gray-300 rounded">
                            </div>
                            <div class="ml-3 text-sm">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="allow_trending" name="allow_trending" type="checkbox" value="1" {{ old('allow_trending', $slide->allow_trending) ? 'checked' : '' }}
                                       class="focus:ring-primary-500 h-4 w-4 text-primary-600 border-gray-300 rounded">
                            </div>
                            <div class="ml-3 text-sm">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="allow_channels" name="allow_channels" type="checkbox" value="1" {{ old('allow_channels', $slide->allow_channels) ? 'checked' : '' }}
                                       class="focus:ring-primary-500 h-4 w-4 text-primary-600 border-gray-300 rounded">
                            </div>
                            <div class="ml-3 text-sm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="genre" id="genre" value="{{ old('genre', $slide->genre) }}"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                    ...
                    <div>
                        ...
                        <input type="text" name="mood" id="mood" value="{{ old('mood', $slide->mood) }}"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                ...
                <div>
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input id="visibility" name="visibility" type="checkbox" value="1" {{ old('visibility', $slide->visibility) ? 'checked' : '' }}
                                   class="focus:ring-primary-500 h-4 w-4 text-primary-600 border-gray-300 rounded">
                        </div>
                        <div class="ml-3 text-sm">
