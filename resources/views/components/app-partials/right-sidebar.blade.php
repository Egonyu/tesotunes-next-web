            ...
            <div x-show="activeTab === 'tabHome'" x-transition:enter="transition-all duration-500 easy-in-out"
                ...
                <div class="mt-4 px-3">
                    ...
                    <div class="mt-3 flex space-x-3">
                        <a href="{{route('frontend.songs.index')}}" class="w-12 text-center">
                        ...
                        <a href="{{route('frontend.home')}}" class="w-12 text-center">
                            <div class="avatar size-10">
                        ...
                        <a href="{{route('frontend.edula')}}" class="w-12 text-center">
                            <div class="avatar size-10">
                        ...
                        <a href="{{route('frontend.playlists.index')}}" class="w-12 text-center">
                            <div class="avatar size-10">
