...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create New Ad</h1>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Add a new advertising campaign</p>
        </div>
    ...
    <form method="POST" action="{{ route('backend.ads.store') }}" enctype="multipart/form-data" 
          x-data="{ type: 'google_adsense', placement: 'inline' }" 
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 space-y-6">
            ...
            <div x-show="type === 'google_adsense'" class="border-b border-gray-200 dark:border-gray-700 pb-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="adsense_slot_id" 
                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white"
                               placeholder="1234567890">
                        <p class="text-xs text-gray-500 mt-1">Get this from your Google AdSense dashboard</p>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="adsense_format"
                            ...
                            <option value="rectangle">Rectangle (336x280)</option>
                            <option value="horizontal">Horizontal (728x90)</option>
                            <option value="vertical">Vertical (120x600)</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="html_code" rows="6" 
                                  ...
                                  placeholder="<div>Your custom HTML/JavaScript here</div>"></textarea>
                        <p class="text-xs text-gray-500 mt-1">Or use image upload below</p>
                    </div>
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="space-y-2">
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="pages[]" value="home" class="rounded">
                                <span class="text-sm">Homepage</span>
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="pages[]" value="discover" class="rounded">
                                <span class="text-sm">Discover</span>
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="pages[]" value="artist" class="rounded">
                                <span class="text-sm">Artist Pages</span>
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="pages[]" value="genres" class="rounded">
                                <span class="text-sm">Genres</span>
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="pages[]" value="playlists" class="rounded">
                                <span class="text-sm">Playlists</span>
                            </label>
                        </div>
                        <p class="text-xs text-gray-500 mt-2">Leave unchecked to show on all pages</p>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">User Tiers</label>
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="user_tiers[]" value="free" class="rounded" checked>
                                <span class="text-sm">Free Users</span>
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="user_tiers[]" value="premium" class="rounded">
                                <span class="text-sm">Premium Users</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="mobile_only" value="1" class="rounded">
                            <span class="text-sm">Mobile Only</span>
                        </label>
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="desktop_only" value="1" class="rounded">
            ...
            <div>
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Priority (Higher = Show First)</label>
                    ...
                    <label class="flex items-center gap-2">
                        ...
                        <span class="text-sm font-medium">Active (show immediately)</span>
                    </label>
                </div>
            </div>
            ...
            <div class="flex gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <a href="{{ route('backend.ads.index') }}" class="px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 dark:text-white font-medium">
                    Cancel
                </a>
            </div>
        </div>
