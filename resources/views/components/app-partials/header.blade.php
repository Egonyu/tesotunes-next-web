        ...
        <div class="flex w-full items-center justify-between">
            ...
            <div class="flex items-center">
                <a href="{{ route('frontend.home') }}">
                    ...
                    @endphp
                    <img class="size-10 transition-transform duration-500 ease-in-out hover:rotate-[360deg] rounded-lg"
                         src="{{ asset($siteLogo) }}" alt="{{ config('app.name') }}" />
                </a>
            </div>
            ...
            <div class="-mr-1.5 flex items-center space-x-2">
                            ...
                            <div
                                ...
                                <div class="is-scrollbar-hidden overflow-y-auto overscroll-contain pb-2">
                                    <div class="is-scrollbar-hidden mt-3 flex space-x-4 overflow-x-auto px-3">
                                        <a href="{{ route('frontend.songs.index') }}" class="w-14 text-center">
                                        ...
                                        </a> <a href="{{ route('frontend.edula') }}" class="w-14 text-center">
                                            <div class="avatar size-12">
                                        ...
                                        <a href="{{ route('frontend.playlists.index') }}" class="w-14 text-center">
                                            <div class="avatar size-12">
                                        ...
                                        <a href="{{ route('frontend.edula') }}" class="w-14 text-center">
                                            <div class="avatar size-12">
                                                <div class="is-initial rounded-full bg-secondary text-white">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                        ...
                                        <a href="{{ route('frontend.artists') }}" class="w-14 text-center">
                                            <div class="avatar size-12">
                                                <div class="is-initial rounded-full bg-info text-white">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                    ...
                                    <div class="mt-1 font-inter font-medium">
                                        ...
                                        <a class="group flex items-center space-x-2 px-2.5 py-2 tracking-wide outline-hidden transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100"
                                            href="{{ route('frontend.songs.index') }}">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="size-4.5 text-slate-400 transition-colors group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200"
                                                fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                                stroke-width="1.5">
                ...
                <button @click="$store.global.isDarkModeEnabled = !$store.global.isDarkModeEnabled"
                    class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 relative">
                    <svg x-show="$store.global.isDarkModeEnabled" x-cloak
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" x-show="!$store.global.isDarkModeEnabled" x-cloak
                        x-transition:enter="transition-transform duration-200 ease-out"
                        x-transition:enter-start="scale-75 opacity-0" x-transition:enter-end="scale-100 opacity-100"
