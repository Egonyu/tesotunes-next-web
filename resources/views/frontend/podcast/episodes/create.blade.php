...
@section('title', 'Create Episode - ' . $podcast->title)
...
<div class="min-h-screen bg-white dark:bg-black">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-white mt-4">Create New Episode</h1>
            <p class="text-gray-400 mt-2">Add a new episode to your podcast</p>
        </div>

        <!-- Form -->
        <form action="{{ route('podcast.episode.store', $podcast->slug) }}" 
              method="POST" 
                    ...
                    <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-400">
                            <label for="audio_file" class="relative cursor-pointer rounded-md font-medium text-green-500 hover:text-green-400">
                                ...
                                <input id="audio_file" name="audio_file" type="file" accept="audio/*" class="sr-only" required>
                            </label>
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-700">
                ...
                <button type="submit" 
                    ...
                    <span class="material-icons-round text-sm align-middle mr-1">add</span>
                    Create Episode
                </button>
            </div>
        </form>
