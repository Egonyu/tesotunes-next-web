    ...
    <div className="container py-8 space-y-8">
      ...
      <div className="text-center max-w-2xl mx-auto">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 text-primary rounded-full mb-4">
          ...
          <span className="font-medium">Ojokotau Campaigns</span>
        </div>
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div>
                      ...
                      <p className="text-muted-foreground">of {(campaign.goal / 1_000_000).toFixed(0)}M goal</p>
                    </div>
                    <div className="text-right">
                      <p className="font-semibold">{campaign.backers}</p>
                      <p className="text-muted-foreground flex items-center gap-1"><Users className="h-3 w-3" />backers</p>
                    </div>
                    <div className="text-right">
                      <p className="font-semibold">{campaign.daysLeft}</p>
                      <p className="text-muted-foreground flex items-center gap-1"><Clock className="h-3 w-3" />days left</p>
                    </div>
                  </div>
                </div>
              </Link>
    ...
    >
      ...
      <div className="p-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-sm text-muted-foreground truncate">{campaign.artist.name}</span>
        </div>
