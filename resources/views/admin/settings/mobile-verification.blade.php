...
@section('title', 'Mobile Verification Management')
...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Mobile Verification Management</h1>
                <p class="mt-1 text-sm text-gray-600">Manage mobile phone verification settings and user verification status</p>
            </div>
        ...
        <div class="bg-white rounded-lg p-6 shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($stats['verified_users']) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg p-6 shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $stats['verification_rate'] }}%</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox"
                                       ...
                                       value="1"
                                       {{ $settings['mobile_verification_enabled'] ? 'checked' : '' }}
                        ...
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox"
                                       ...
                                       value="1"
                                       {{ $settings['mobile_verification_required_for_events'] ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox"
                                       ...
                                       value="1"
                                       {{ $settings['mobile_verification_required_for_artists'] ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div>
                            ...
                            <select name="mobile_verification_sms_provider"
                                ...
                                <option value="local" {{ $settings['sms_provider'] === 'local' ? 'selected' : '' }}>Local (Log Only)</option>
