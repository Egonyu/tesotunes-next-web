...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-black py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="bg-gray-800 rounded-lg p-8 border border-gray-700">
            <!-- Social Login Buttons (Conditional based on settings) -->
            ...
            <div class="space-y-3 mb-6">
                ...
                <a href="{{ route('auth.social.redirect', 'google') }}" 
                   class="w-full bg-white hover:bg-gray-100 text-gray-900 font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-3">
                ...
                <a href="{{ route('auth.social.redirect', 'facebook') }}"
                   class="w-full bg-[#1877F2] hover:bg-[#166FE5] text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-3">
                ...
                <a href="{{ route('auth.social.redirect', 'twitter') }}"
                   class="w-full bg-[#1DA1F2] hover:bg-[#1A8CD8] text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-3">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative mb-6">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-2 bg-gray-800 text-gray-400">Or continue with {{ app(\App\Models\Setting::class)::get('auth_email_login_enabled', true) && app(\App\Models\Setting::class)::get('auth_phone_login_enabled', true) ? 'email/phone' : (app(\App\Models\Setting::class)::get('auth_phone_login_enabled', true) ? 'phone' : 'email') }}</span>
                </div>
            </div>
            @endif

            <form method="POST" action="{{ route('user.login') }}" x-data="loginForm()">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input
                        ...
                        required
                        value="{{ old('email') }}"
                        class="w-full bg-gray-700 text-white rounded-lg px-4 py-3 border border-gray-600 focus:border-blue-500 focus:outline-none @error('email') border-red-500 @enderror"
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <input
                            ...
                            required
                            class="w-full bg-gray-700 text-white rounded-lg px-4 py-3 pr-12 border border-gray-600 focus:border-blue-500 focus:outline-none @error('password') border-red-500 @enderror"
