...
return [
    ...
    */
    'membership' => [
        ...
        'membership_number_prefix' => env('SACCO_MEMBERSHIP_PREFIX', 'SACCO'),
    ...
    /*
    |--------------------------------------------------------------------------
    | Auto-Enrollment Configuration (Phase 2)
    |--------------------------------------------------------------------------
    */
    'auto_enrollment' => [
        'enabled' => env('SACCO_AUTO_ENROLLMENT_ENABLED', true),
        'auto_approve_all' => env('SACCO_AUTO_APPROVE_ALL', false),
        'auto_approve_artists' => env('SACCO_AUTO_APPROVE_ARTISTS', true),
        'auto_approve_premium_users' => env('SACCO_AUTO_APPROVE_PREMIUM', true),
        'min_account_age_days' => env('SACCO_MIN_ACCOUNT_AGE', 90),
    ],
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Phase 4: Credit-to-Cash Conversion (Platform Credits → SACCO Savings)
    |--------------------------------------------------------------------------
    */
    'credit_exchange' => [
        'enabled' => env('SACCO_CREDIT_EXCHANGE_ENABLED', true),
        'rate' => env('SACCO_CREDIT_EXCHANGE_RATE', 100), // 100 credits = 1 UGX
        'minimum_conversion' => env('SACCO_MIN_CREDIT_CONVERSION', 1000), // Min 1000 credits
        'maximum_conversion_daily' => env('SACCO_MAX_DAILY_CREDIT_CONVERSION', 50000), // Max 50,000 credits/day
        'transaction_fee_percentage' => env('SACCO_CREDIT_CONVERSION_FEE', 0), // % fee on conversion
        'requires_kyc' => env('SACCO_CREDIT_CONVERSION_KYC', false), // KYC required for conversions
    ],
