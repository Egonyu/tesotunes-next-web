    ...
    <div class="card mb-6">
        <div class="border-b border-slate-200 p-4 dark:border-navy-500">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('admin.music.albums.create') }}" class="btn bg-primary text-white hover:bg-primary-focus">
                ...
                <div class="p-4">
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <a href="{{ route('backend.music.albums.show', $album) }}" class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                            ...
                            <a href="{{ route('backend.music.albums.edit', $album) }}" class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="flex items-center space-x-1">
                            @if($album->status === 'pending')
                                <form method="POST" action="{{ route('backend.music.albums.approve', $album) }}" class="inline">
                                    @csrf
                            ...
                            <form method="POST" action="{{ route('backend.music.albums.destroy', $album) }}" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25"
