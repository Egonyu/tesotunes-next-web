...
export default function PromotersDiscoveryPage({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div className={embedded ? "space-y-6" : "container mx-auto max-w-7xl py-8 space-y-6"}>
      {/* Header */}
      <div className={embedded ? "hidden" : "rounded-xl bg-card shadow-sm p-6"}>
      ...
      <div className="rounded-xl bg-card shadow-sm p-5 space-y-4">
        ...
        <details className="rounded-lg border p-3">
          <summary className="cursor-pointer text-sm font-semibold">Filter by platform, niche or tier{platform || niche || tier ? ' · active' : ''}</summary>
              ...
              {promoters.map((promoter) => {
                ...
                return (
                  <Link
                    ...
                    className="group block min-w-0 rounded-xl bg-card p-3 shadow-sm transition-shadow hover:shadow-md sm:p-5"
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1.5">
                          <p className="line-clamp-2 break-words text-sm font-semibold transition-colors group-hover:text-primary sm:text-base">
