...
export default function PromotionsBrowsePage({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div className={embedded ? "" : "container mx-auto py-8"}>
      <div className="space-y-6">
        <section className={embedded ? "hidden" : "rounded-lg border bg-card p-5"}>
        ...
        <section className="space-y-6">
          <section className="rounded-lg border bg-card p-5">
            <details className="rounded-lg border p-3 sm:border-0 sm:p-0">
              <summary className="cursor-pointer text-sm font-semibold">Refine services{hasActiveFilters ? ` · ${activeFilterEntries.length} active` : ''}</summary>
              <div className="mt-3"><PromotionFilters /></div>
            </details>
